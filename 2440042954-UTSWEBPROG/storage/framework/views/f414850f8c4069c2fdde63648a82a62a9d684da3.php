...
<div class="container-fluid" style="background-color: #AA8B56; height: 100vh;">
    <div class="pt-3">
        <div class="container text-white p-3" style="background-color: #395144;">
            <h3><?php echo e($book->users->name); ?></h3>
            <h3>Address - <?php echo e($book->users->address); ?></h3>
            <h3>Phone - <?php echo e($book->users->phone); ?></h3>
            <h3>Email - <?php echo e($book->users->email); ?></h3>
        </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\2440042954-UTSWEBPROG\resources\views/pages/publisherdetail.blade.php ENDPATH**/ ?>