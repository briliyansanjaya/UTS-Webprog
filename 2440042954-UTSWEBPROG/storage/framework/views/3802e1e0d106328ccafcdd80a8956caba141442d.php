    ...
    <div class="container pb-5">
        ...
        <div class="card my-4">
            ...
            <div class="card-body">
                ...
                <p>Publisher : <?php echo e($book->users->name); ?> </p>
                <p>Phone Publisher : <?php echo e($book->users->phone); ?></p>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\2440042954-UTSWEBPROG\resources\views/pages/bookdetail.blade.php ENDPATH**/ ?>